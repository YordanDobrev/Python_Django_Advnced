"""
Django settings for ExamPrep_WOS project.
...
SECRET_KEY = 'django-insecure-9sof%m%)6ekaq+-1+i+izbnafzwfesq+ta)@0u9=ejh9$%xb)x'
...
ROOT_URLCONF = 'ExamPrep_WOS.urls'
...
WSGI_APPLICATION = 'ExamPrep_WOS.wsgi.application'
